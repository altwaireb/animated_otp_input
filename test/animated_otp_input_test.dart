...
void main() {
  ...
  testWidgets('delete digit moves focus to previous field and shows error', (
    ...
    await tester.pumpWidget(
      const MaterialApp(home: Scaffold(body: AnimatedOtpInput(length: 4))),
    );
  ...
  testWidgets('custom theme applies animation style', (tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: AnimatedOtpInput(length: 4, theme: theme)),
      ),
    );
    ...
    final animatedScale = tester.widget<AnimatedScale>(
      find.byType(AnimatedScale).at(2),
    );
  ...
  testWidgets('pasting incomplete OTP does not fill all fields', (
    ...
    final field0 = tester.widget<TextFormField>(
  ...
  testWidgets('focus animation triggers on field focus', (tester) async {
    ...
    final animatedScale = tester.widget<AnimatedScale>(
      find.byType(AnimatedScale).at(1),
    );
  ...
  testWidgets('renders correct number of input fields', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(home: Scaffold(body: AnimatedOtpInput(length: 6))),
    );
  ...
  testWidgets('disables all input fields when enabled is false', (
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: AnimatedOtpInput(length: 4, enabled: false)),
      ),
    );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final textWidget = tester.widget<Text>(
        find.text('Please fill all fields'),
      );
